...
namespace Vectores
{
    internal class OperacionesVectoriales : Vector
    {
        ...
        //Suma Vectorial
        public double[]? SumaVectorial(double[] vectorA, double[] vectorB)
        {
        ...
        //Resta Vectorial
        public double[]? RestaVectorial(double[] vectorA, double[] vectorB)
        {
            if (vectorA.Length == vectorB.Length)
            {
                double[] sumVec = new double[vectorA.Length];
        ...
        //Opuesto Vectorial
        public double[] OpuestoV(double[] vector)
        {
        ...
        public double[] ProductXEscalar(double[] vector, double escalar)
        {
        ...
        public double PuntoV(double[] vectorA, double[] vectorB)
        {
            double puntoVec = 0;
            for(int i = 0; i < vectorA.Length; i++)
            {
        ...
        public double[]? CruzV(double[] vectorA, double[] vectorB)
        {
            double[] cruzV;
        ...
        public double AngulosEntreVectores(double[] vecA, double[] torB)
        {
            double basado = NormalV(vecA) * NormalV(torB);
            double ang;
            try
            {
                ang = Math.Acos((PuntoV(vecA, torB)) / basado);
                return ang;
            }
        ...
        public bool VerificacionOrtogonal(double[] vecA, double[] torB)
        {
        ...
        public bool VerificacionParalelo(double[] vecA, double[] torB)
        {
            if (torB[0] != 0)
            {
                switch (vecA.Length)
        ...
        public double[]? ProyecciondeAsobreB(double[] vecA, double[] torB)
        {
            try
            {
